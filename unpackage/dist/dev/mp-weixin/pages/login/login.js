...
/* harmony import */ var _login_vue_vue_type_template_id_fe8b4ca4___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./login.vue?vue&type=template&id=fe8b4ca4& */ 33);
...
//
//
var mInput = function mInput() {return __webpack_require__.e(/*! import() | components/m-input */ "components/m-input").then(__webpack_require__.bind(null, /*! ../../components/m-input.vue */ 149));};var SubmitButton = function SubmitButton() {return __webpack_require__.e(/*! import() | components/submit-button/submit-button */ "components/submit-button/submit-button").then(__webpack_require__.bind(null, /*! @/components/submit-button/submit-button.vue */ 128));};var _default = { components: { mInput: mInput, 'submit-button': SubmitButton }, data: function data() {return { providerList: [], hasProvider: false, account: '', password: '', positionTop: 0, btnMsg: '登录' };}, methods: { userLogin: function userLogin() {uni.navigateTo({ url: '../index/index' });}, initProvider: function initProvider() {var _this = this;var filters = ['weixin', 'qq', 'sinaweibo'];uni.getProvider({ service: 'oauth', success: function success(res) {
